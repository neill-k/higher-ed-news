  ...
  return (
    ...
    >
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        />
        <BAN
          label="LSU's enterprise AI stack"
      ...
      <Exhibit
        number="V1"
        title="SEC vendor-deployment matrix — who's running what"
        subtitle="Classifies each peer's disclosed deployments into the five enterprise stacks CIOs are actually comparing."
      ...
      >
        ...
        <Callout kind="implication">
          ...
          the frontier-model layer. LSU's MikeGPT (OpenAI via Azure, custom RAG on 35K curated
