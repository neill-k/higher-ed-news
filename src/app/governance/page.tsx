    ...
    >
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <BAN
          ...
          tone="danger"
          comparator="Louisiana Board of Regents adopted the SEC&rsquo;s first statewide postsecondary AI policy on Oct 22, 2025."
        />
        <BAN
          label="SEC states with a governor&rsquo;s AI executive order"
          value={`${stateEOCount}`}
      ...
      <Exhibit
        number="G1"
        title="Louisiana&rsquo;s AI governance stack — what binds LSU that peers outside LA don&rsquo;t carry"
      ...
      >
        <div className="grid gap-4 md:grid-cols-3">
          <Panel className="border-[#ebe7dd] bg-[#fdfaf1]">
            ...
            <h3 className="mt-1 text-[15px] font-semibold text-[#2d2926]">
              Governor&rsquo;s Executive Order
            </h3>
          ...
          <Panel className="border-[#ebe7dd] bg-[#fdfaf1]">
            ...
            <p className="mt-2 text-[12.5px] leading-[1.6] text-[#5e5954]">
              ...
              adopt conforming institutional policies. Regents&rsquo; standing AI Committee is the direct
              oversight body.
            </p>
            <div className="mt-2 flex flex-wrap gap-x-3 gap-y-1">
        ...
        <Callout kind="action">
          ...
          Regents&rsquo; statewide policy, and the Faculty Senate guidelines are treated as a single
          ...
          <table className="min-w-full text-left text-sm">
            <thead className="bg-[#f5f2e9] text-[10px] uppercase tracking-[0.16em] text-[#8c8782]">
              <tr>
                ...
                <th className="px-3 py-2.5 font-medium">Governor&rsquo;s AI EO</th>
              </tr>
            </thead>
            <tbody>
              {[...secPeers]
      ...
      <Exhibit
        ...
        subtitle="These are coverage percentages, not risk levels. Interpret them as &rsquo;share of institutions where signals exist,&rsquo; not as a quantified risk score."
