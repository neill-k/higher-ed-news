...
export default async function PeersPage() {
  ...
  return (
    <ReportPage
      ...
      title="Peer profiles"
      subtitle="Primary-source AI posture for all 16 SEC institutions. Each card was researched and verified against the school's own disclosures; evidence URLs are attached to every substantive claim."
    >
      <Exhibit
        number="P"
        title="Methodology in a sentence"
        subtitle="Each profile was researched from the institution's own website, state government sources, and specialist higher-ed reporting (EDUCAUSE, Chronicle, Inside Higher Ed). Every non-trivial claim has a primary source URL. Fields left null are explicit gaps, not errors — see confidence notes on each peer's source list."
      ...
      >
        <div className="text-[13px] leading-[1.6] text-[#2d2926]">
          Sort order: LSU pinned first, then alphabetical. Tier badges indicate LSU's own peer
