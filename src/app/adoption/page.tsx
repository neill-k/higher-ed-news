...
export default async function AdoptionPage() {
  ...
  return (
    ...
    >
      ...
      <Callout kind="action">
        Two asymmetric opportunities visible from this page: (1) LSU launched Louisiana's first BS
        in AI for Fall 2026 and an AI Essentials dual-enrollment pipeline — few SEC peers have
        either. That's a reputational lead if leaned into. (2) On formal governance bodies LSU is
